...
public class CryptoApp {
    ...
    public static ArrayList <Integer> encrypt(String s, int key)  { //diamond symbol <>
    ...
    public static char decipher (int cipher, int prev, int key) {
        ...
        de = (cipher - prev + key) % key;  //in case it is an integer, because java cannot calculate the mod of a negative number
        return (char) de;
    }
}
